    ...
    async function videoProcess(newVideoState) {
        if (newVideoState == video_states.None) {
            ...
            $("#ScreenShareOnOf").html(
                '<span class="material-icons">present_to_all</span></div><div>Present Now</div></div>'
            );
        ...
        try {
            ...
            if (newVideoState == video_states.Camera) {
                ...
                $("#ScreenShareOnOf").html(
                    '<span class="material-icons text-sucess">present_to_all</span></div><div>Stop Present Now</div></div>'
                );
            }
...
var MyApp = (function () {
    ...
    function event_process_for_signaling_server() {
        ...
        socket.on("inform_other_about_disconneted_user", function (data) {
            $("#" + data.connId).remove();
    ...
    function addUser(other_user_id, connId, userNum) {
        ...
        $(".in-call-wrap-up").append(
            ...
            connId +
            '" style=""> <div class="participant-img-name-wrap display-center cursor-pointer"> <div class="participant-img"> <img src="public/assets/images/other.jpg" alt="" class="border border-secondary" style="height: 40px;width: 40px;border-radius: 50%;"> </div> <div class="participant-name ml-2">' +
            other_user_id +
